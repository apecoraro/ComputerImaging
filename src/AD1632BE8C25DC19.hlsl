// dxc -EQuadCount -T cs_6_0 /Zi /Zss -Od -Qembed_debug .\AD1632BE8C25DC19.hlsl
...
void QuadCount(uint3 dispatchId : SV_DispatchThreadID)
{
    ...
    uint redBit = ComputeBinNumber(inputTex.Load(int3(dispatchId.xy, 0)).r * 255.0);
    if (binNumber1 == redBit)
        binCounts.r += 1;
    if (binNumber2 == redBit)
        binCounts.g += 1;

    redBit = ComputeBinNumber(inputTex.Load(basePixelIndex + int3(1, 0, 0)).r * 255.0);
    if (binNumber1 == redBit)
        binCounts.r += 1;
    if (binNumber2 == redBit)
        binCounts.g += 1;

    redBit = ComputeBinNumber(inputTex.Load(basePixelIndex + int3(0, 1, 0)).r * 255.0);
    if (binNumber1 == redBit)
        binCounts.r += 1;
    if (binNumber2 == redBit)
        binCounts.g += 1;

    redBit = ComputeBinNumber(inputTex.Load(basePixelIndex + int3(1, 1, 0)).r * 255.0);
    if (binNumber1 == redBit)
        binCounts.r += 1;
    if (binNumber2 == redBit)
        binCounts.g += 1;
